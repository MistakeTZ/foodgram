...
urlpatterns = [
    path("users/<int:user_id>/", views.users.UserView.as_view(), name="user"),
    path("users/me/", views.users.MeView.as_view(), name="me"),
    ...
    path(
        "users/subscriptions/",
        views.subscription.subscribtions,
        name="subscribtions"
    ),
    path(
    ...
    path(
        ...
        views.favorites.favorite,
        name="favorite"
    ),
    path(
        "recipes/<int:recipe_id>/shopping_cart/",
        views.cart.shopping_cart,
        name="shopping_cart",
    ),
    path(
        "recipes/download_shopping_cart/",
        views.cart.download_shopping_cart,
